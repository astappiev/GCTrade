...
class Users extends \yii\base\Module {
    ...
    */
    ...
    /**
     * @var array Model classes, e.g., ["User" => "app\modules\users\models\User"]
     * Usage:
     *   $user = Yii::$app->getModule("user")->model("User", $config);
     *   (equivalent to)
     *   $user = new \app\modules\users\models\User($config);
     *
    ...
    */
    ...
    protected function _getDefaultModelClasses() {
        ...
        return [
            ...
            'Userkey' => 'app\modules\users\models\Userkey',
            'ForgotForm' => 'app\modules\users\models\forms\ForgotForm',
            'LoginForm' => 'app\modules\users\models\forms\LoginForm',
            'ResendForm' => 'app\modules\users\models\forms\ResendForm',
            'ResetForm' => 'app\modules\users\models\forms\ResetForm',
            'UserSearch' => 'app\modules\users\models\search\UserSearch',
        ];
    }
